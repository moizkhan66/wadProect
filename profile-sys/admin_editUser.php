...
<?php 
    ...
    if(isset($_POST['edit_user']))
    {
        ...
        `license_id`=:licId,`license_ed`=:licEd,`user_status`=:userStatus,`user_contact`=:userNum WHERE `user_id` = ". $userId;
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="panel panel-default">
        <?php 
            if(isset($_POST['edit_user'])){
                if($pdoExec)
                {
                    ...
                    header("Location: admin_user.php?user=" . $userId);
                }else{
        ...
        <div class="panel-body">
            <form class="form-horizontal row-border" action="admin_editUser.php" method="post">
                <div class="form-group">
                    <label class="col-md-2 control-label">User UserName</label>
                    <div class="col-xs-5">
                        <input type="text" name="user_username" class="form-control" value="<?php echo $row['user_username'];?>" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input type="number" name="user_num" class="form-control" required value="<?php echo $row['user_contact'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">User Status</label>
                    <div class="col-xs-5">
                        <input type="text" name="user_status" class="form-control" required value="<?php echo $row['user_status'];?>">
                    </div>
                </div>
                <div class="form-group">   
                    <input type="hidden" name="user_id" class="form-control" value="<?php echo $user_id;?>"> 
                    <button type="submit" name="edit_user" class="btn btn-primary center-block">Edit User</button>
                </div>
            </form>
        </div>
    </div>
